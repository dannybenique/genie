    ...
    if (isset($_REQUEST["appSQL"])){
      ...
      switch ($data->TipoQuery) {
        ...
        case "newBilletaje":
          ...
          $qry = $db->query_all("select nombrecorto from app_empleados where id_empleado=".$data->usuarioID);
        ...
        case "StartBilletaje":
          ...
          $rpta = array(
            ...
            "rolID" => $rolID,
            "userID" => $_SESSION['usr_ID'],
            "comboUsuarios" => $fn->getComboBox("select id_empleado as id,nombrecorto as nombre from app_empleados where estado=1 and id_coopac=".$web->coopacID.(($rolID>102)?(" and id_empleado=".$_SESSION['usr_ID']):(""))),
            "comboAgencias" => $fn->getComboBox("select id,nombre from bn_bancos where estado=1 and id_padre=".$web->coopacID),
            "comboMonedas" => $fn->getComboBox("select id,nombre from sis_tipos where id_padre=1")
          );
          header('Content-Type: application/json');
