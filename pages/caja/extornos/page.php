...
<section class="content-header">
  <h1><i class="fa fa-crop"></i> <b>Extornos</b></h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">extornos</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  <div class="row" id="edit">
    <div class="col-md-4">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title" style="font-family:flexoregular;"><b>Datos de Movimiento</b></h3>
        </div>
        <div class="box-body">
          <div class="box-body">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="number" id="modalCredi_Buscar" class="form-control" placeholder="DNI, RUC..." onkeypress="javascript:modalCredi_keyBuscar(event);">
...
<script src="pages/caja/extornos/script.js"></script>
<script>
