...
<section class="content-header">
  <h1><i class="fa fa-gear"></i> <b>Personas</b></h1>
  <ol class="breadcrumb">
      ...
      <div class="modal-content">
        <form class="form-horizontal" id="frm_modalAuditoria" autocomplete="off">
          <div class="modal-header" style="background:#f9f9f9;padding:8px;">
            ...
            <h4 class="modal-title" style="font-family:flexoregular;">Auditoria de acciones para... <span id="lbl_modAuditoriaTitulo"></span></h4>
          </div>
